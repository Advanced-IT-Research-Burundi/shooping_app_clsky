...
function MenuItem({ icon, label, iconBg, iconColor, showChevron = true }: MenuItemProps) {
  return (
    <button className="w-full flex items-center gap-4 p-4 active:bg-gray-50 transition">
