...
export function ProductList({ products, onProductClick }) {
  ...
  />
    ...
    className={`px-4 py-2 rounded-full text-sm whitespace-nowrap transition-all ${filterType === "all" ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700"}`}
  >
            Tous
          </button>
    ...
    className={`px-4 py-2 rounded-full text-sm whitespace-nowrap transition-all flex items-center gap-2 ${filterType === key ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700"}`}
  >
  ...
  />
              ...
              {product.packaging === "carton" && <div className="absolute top-2 left-2 bg-blue-500 text-white p-1.5 rounded-lg">
