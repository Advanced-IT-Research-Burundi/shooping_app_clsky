...
export default function App() {
  ...
  const [products, setProducts] = useState([
    {
      ...
      description: "Dernier mod\xE8le avec \xE9cran AMOLED",
      price: 450,
      currency: "USD",
      exchangeRate: 2850,
    ...
    },
    {
      id: "2",
      name: "T-Shirts Coton",
      description: "Lot de t-shirts haute qualit\xE9",
      price: 120,
      currency: "USD",
      exchangeRate: 2850,
      convertedPrice: 342e3,
      type: "clothing",
      packaging: "carton",
      piecesPerCarton: 24,
      numberOfCartons: 5,
    ...
    },
    {
      id: "3",
      name: "Riz Parfum\xE9",
      description: "Sacs de riz de qualit\xE9 premium",
      price: 85,
      currency: "USD",
      exchangeRate: 2850,
  ...
  return <div className="min-h-screen bg-gray-50 pb-20 max-w-md mx-auto relative">
      {currentScreen === "home" && <Home
    products={products}
    onAddClick={() => setCurrentScreen("add")}
    onProductClick={handleViewDetail}
  />}
      {currentScreen === "add" && <AddPurchase
    onSubmit={handleAddProduct}
    onCancel={() => setCurrentScreen("home")}
  />}
      {currentScreen === "products" && <ProductList
    products={products}
    onProductClick={handleViewDetail}
  />}
      {currentScreen === "detail" && selectedProduct && <ProductDetail
